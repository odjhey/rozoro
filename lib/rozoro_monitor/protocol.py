...
_SCHEMAS: dict[str, tuple[dict[str, Callable[[Any, str], None]], dict[str, Callable[[Any, str], None]]]] = {
    ...
    "driver.authority": ({"request_id": _ID, "driver_id": _ID}, {}),
    "driver.authority.result": ({"request_id": _ID, "driver_id": _ID,
                                 "authority": _enum("active", "disabled", "unknown")}, {}),
    ...
    "reconcile.pending": ({"request_id": _ID, "driver_id": _ID}, {"scope": _enum("delta", "full")}),
    "reconcile.pending.result": ({"request_id": _ID, "through": _NONNEGATIVE,
                                  "reports": lambda value, field: _reports(value, field)},
                                 {"since": _NONNEGATIVE, "unchanged_count": _NONNEGATIVE}),
    ...
    "health.result": ({"request_id": _ID, "running": _BOOL, "socket": _STRING,
                       ...
                       "driver_count": _NONNEGATIVE, "generation": _NONNEGATIVE,
                       "delivered_generation": _NONNEGATIVE, "acked_generation": _NONNEGATIVE,
                       "pending_count": _NONNEGATIVE, "spool_backlog": _NONNEGATIVE,
                       "spool_errors": _NONNEGATIVE, "pid": _POSITIVE},
                      {"last_durable_time": _nullable(_STRING),
                       "last_spool_error": _nullable(_STRING),
    ...
    "watchtower.availability.result": ({"request_id": _ID, "driver_id": _ID,
