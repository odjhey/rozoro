...
- **Task Decomposer, Sol High**
  - Break the rough plan into bounded tasks that a coder can execute.
  - Use the existing contracts, ports, repo docs, dependencies, and boundaries.
...
- **Escalation Replanner, Sol Medium**
