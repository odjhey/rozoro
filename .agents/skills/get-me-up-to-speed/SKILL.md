...
2. Always format the answer under exactly these three headings, in this order: **Done**, **Current**, and **Next**. Do not substitute task names or a flat list for these headings. Include project/workset identity and exact branch or head when it matters.
