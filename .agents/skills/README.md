...
| `get-me-up-to-speed` | Give an operator-first conversational report with explicit human actions, capability-level landed outcomes, current state, and an ordered next route; also triggered by `gmuts`. |
