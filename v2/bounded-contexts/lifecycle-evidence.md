---
name: v2_lifecycle_evidence_context
...
> **v2 working copy** — forked from [`docs/architecture/bounded-contexts/lifecycle-evidence.md`](../../docs/architecture/bounded-contexts/lifecycle-evidence.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
