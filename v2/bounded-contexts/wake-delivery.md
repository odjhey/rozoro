...
> **v2 working copy** — forked from [`docs/architecture/bounded-contexts/wake-delivery.md`](../../docs/architecture/bounded-contexts/wake-delivery.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
