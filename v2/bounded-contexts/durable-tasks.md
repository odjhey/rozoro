...
> **v2 working copy** — forked from [`docs/architecture/bounded-contexts/durable-tasks.md`](../../docs/architecture/bounded-contexts/durable-tasks.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
