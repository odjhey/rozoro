...
> **v2 working copy** — forked from [`docs/architecture/rewrite-seams.md`](../docs/architecture/rewrite-seams.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
