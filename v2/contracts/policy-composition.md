---
name: v2_contract_policy_composition
...
> **v2 working copy** — forked from [`docs/architecture/contracts/policy-composition.md`](../../docs/architecture/contracts/policy-composition.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
