...
> **v2 working copy** — forked from [`docs/architecture/contracts/task-folder.md`](../../docs/architecture/contracts/task-folder.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
