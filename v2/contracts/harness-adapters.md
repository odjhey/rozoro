---
name: v2_contract_harness_adapters
...
> **v2 working copy** — forked from [`docs/architecture/contracts/harness-adapters.md`](../../docs/architecture/contracts/harness-adapters.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
