...
> **v2 working copy** — forked from [`docs/architecture/contracts/cli.md`](../../docs/architecture/contracts/cli.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
