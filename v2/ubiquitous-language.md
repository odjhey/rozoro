...
> **v2 working copy** — forked from [`docs/architecture/ubiquitous-language.md`](../docs/architecture/ubiquitous-language.md) at `b044dbe`. Iterate here; the v2 effort never edits the live architecture docs.
