...
- [ADR-0006: Resolve cross-machine Watchtower policy differences](0006-cross-machine-watchtower-policy-resolution.md) — superseded by ADR-0009 for its stated scope; ADR-0012 separately supersedes only its concrete repository-owned role/model/effort table and Quick Crew model choice
...
- [ADR-0009: Use workset mergers, runner crews, and machine-local routing profiles](0009-workset-merger-runner-and-machine-profile.md) — remains authoritative for machine-profile purpose and runtime verification; fixed delivery-role roster and implementation-only repair-accounting boundary superseded by ADR-0014
