...
- [ADR-0009: Use workset mergers, runner crews, and machine-local routing profiles](0009-workset-merger-runner-and-machine-profile.md) — remains authoritative for machine-profile purpose and runtime verification
